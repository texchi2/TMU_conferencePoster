...
%\1 many achievements and getting published, including \underline{Chi} et al., 2021~\parencite{Chi2021}.
\1 "an immeasurable source of knowledge"~\parencite{Tomczak2015}
\1 The results were published\parencite{Chi2021} (at \url{https://www.mdpi.com/2075-4426/11/8/782/htm}) and shown here are in part based upon data generated by the TCGA Research Network: \url{https://www.cancer.gov/tcga}.
\end{outline}
\begin{center}
% QR code
...
%    \0 An in-house workflow---pvalueTex
        ...
        \1 Cox proportional hazard modeling~\parencite{Cox1972,Bradburn2003b}\: % Andersen1982,
...
%\end{outline}
        \1 validation by (GSE65858)~\parencite{Wichmann2015}
\end{outline}
\end{posterbox}
%
...
\begin{outline}
    \1 Despite the improvements in those interventions, the survival of \acrshort{hnscc} has improved only marginally over the past decade worldwide~\parencite{hpa2019}.
...
Holistic (whole) cancer care~\parencite{Mehta2019,Iftikhar2021}: to care \underline{spirit}, \underline{emotion}, \underline{the body} of a person, and his \underline{social} relation.
...
\1 \underline{therapeutic relationship (TR)}~\parencite{Rogers1979}, the physicians' spiritual properties \underline{(empathy, sympathy, and compassion)} will engage cancer patients
\1 to induce their \underline{self-compassion} to gain \underline{resilience against} the disease through their mind--brain--body axis~\parencite{Hsiao2012}
