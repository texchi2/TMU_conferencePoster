...
%the Eye Catcher (the logo on the left)
{
  ...
  \includegraphics[height=0.35\headerheight]{TMU_logo.png} %{https://www.tmu.edu.tw/images/title.png}
}
%the poster title
{\color{white}\bf
  \Large A Transcriptomic Analysis of Head and Neck Squamous Cell Carcinomas for Prognostic Indication
}
%the author(s)
{\color{white}\small
  \vspace{1em} Li-Hsing (Tex) Chi \\[0.5em] % Jesper Kjær Nielsen
...
{
  %this can be commented out or replaced by a company/department logo
  \includegraphics[height=0.25\headerheight]{TMWH_logo.png}
}
...
\begin{center}
    ...
    \captionof{figure}{A workflow of pvalueTex}
    \label{fig:workflow}
\end{center}   
    ...
    \0 An in-house workflow---pvalueTex
        ...
        \1 Cox proportional hazard modeling~\cite{Cox1972,Andersen1982,Bradburn2003b}\:
...
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figure_4_CAMK2N1_CALML5_FCGBP.pdf}
  \captionof{figure}{
...
%%%\label{tab:newTable1}
\resizebox{0.98\linewidth}{!}{% \textwidth
...
(1) Kaplan--Meier Bonferroni-adjusted~\hl{\textit{p} \textless~0.05} in TCGA; \\
(2) Cox's univariate and multivariate \hl{HR \textgreater{}= 1.8 or \textless{}= 0.6} in both HNSCC (TCGA) and HNSCC (GSE65858) cohorts.\\
%(3) Cox's univariate and multivariate HR \textgreater{}= 1.8 or \textless{}= 0.6 in GSE65858 cohort.\\
*~Cox's model: \hl{\textit{p} \textless 0.001}\\
...
\captionof{figure}{A volcano plot of candidate genes in \hl{HNSCC (TCGA)}.\\
    \textcolor{red}{Red spots}: HR > 1.0;
    \textcolor{green}{Green spots}: HR < 1.0;
    \textcolor{red}{Red dash line}: FDR \textit{p} = 0.05.\\
    \textcolor{red}{CAMK2N1}, \textcolor{red}{CALML5}, \textcolor{red}{FCGBP}, and  other 17 genes had \hl{hazard ratios (HRs)} >$1.8$ or <$0.6$ and \hl{Bonferroni-adjusted} KM \textit{p} values $< 0.05$.
    }
\end{center}
