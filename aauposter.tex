...
%the Eye Catcher (the logo on the left)
{
  ...
  \includegraphics[height=0.55\headerheight]{TMU_TMWH_logo.pdf} %{https://www.tmu.edu.tw/images/title.png}
}
%the poster title
{\color{white}\bf
...
\begin{center}
% QR code
\footnotesize \hl{Full Article Text is published\cite{Chi2021}} at \url{https://www.mdpi.com/2075-4426/11/8/782/htm}
\includegraphics[width=0.2\textwidth]{QRcode_JPM-1309345.png}
\end{center}
